...
Moving on, we will use the the results from the difference graph as it serves better for our goal, as we want to extrapolate the differences between subject's brains that are Autism Spectrum Disorder and those Typically Developed
...
G.dif <- asso_graph_diff(R.asd, R.td, tau = 0)
R.dif <- R.asd - R.td

as_tbl_graph(G.dif * R.dif, directed = FALSE) %>%
